...
module Facebook.Logdevice.Thrift.Maintenance.Maintenance.Types
...
data MaintenanceDefinition = MaintenanceDefinition{maintenanceDefinition_shards
                                                   ::
                                                   Facebook.Logdevice.Thrift.Common.Common.ShardSet,
                                                   maintenanceDefinition_shard_target_state ::
                                                   Facebook.Logdevice.Thrift.Nodes.Nodes.ShardOperationalState,
                                                   maintenanceDefinition_sequencer_nodes ::
                                                   [Facebook.Logdevice.Thrift.Common.Common.NodeID],
                                                   maintenanceDefinition_sequencer_target_state ::
                                                   Facebook.Logdevice.Thrift.Nodes.Nodes.SequencingState,
                                                   ...
                                                   maintenanceDefinition_group_id ::
                                                   Prelude.Maybe
                                                     Facebook.Logdevice.Thrift.Common.Common.MaintenanceGroupID,
                                                   maintenanceDefinition_last_check_impact_result ::
                                                   Prelude.Maybe
                                                     Facebook.Logdevice.Thrift.Safety.Safety.CheckImpactResponse,
                                                   maintenanceDefinition_expires_on ::
                                                   Prelude.Maybe
                                                     Facebook.Logdevice.Thrift.Common.Common.Timestamp,
