...
module Facebook.Logdevice.Thrift.ClusterMembership.ClusterMembership.Types
...
aNY_NODE_IDX :: Facebook.Logdevice.Thrift.Common.Common.NodeIndex
aNY_NODE_IDX = (-1)

newtype AddSingleNodeRequest = AddSingleNodeRequest{addSingleNodeRequest_new_config
                                                    ::
                                                    Facebook.Logdevice.Thrift.Nodes.Nodes.NodeConfig}
                               deriving (Prelude.Eq, Prelude.Show, Prelude.Ord)
