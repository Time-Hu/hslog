...
module Facebook.Logdevice.Thrift.Safety.Safety.Types
...
data ShardMetadata = ShardMetadata{shardMetadata_data_health ::
                                   Facebook.Logdevice.Thrift.Nodes.Nodes.ShardDataHealth,
                                   shardMetadata_is_alive :: Prelude.Bool,
                                   shardMetadata_storage_state ::
                                   Facebook.Logdevice.Thrift.Nodes.Nodes.ShardStorageState,
                                   shardMetadata_location :: Prelude.Maybe Text.Text,
                                   shardMetadata_location_per_scope ::
...
data ImpactOnEpoch = ImpactOnEpoch{impactOnEpoch_log_id ::
                                   ...
                                   impactOnEpoch_epoch ::
                                   Facebook.Logdevice.Thrift.Common.Common.Unsigned64,
                                   impactOnEpoch_storage_set ::
                                   Facebook.Logdevice.Thrift.Common.Common.StorageSet,
                                   impactOnEpoch_replication ::
                                   Facebook.Logdevice.Thrift.Common.Common.ReplicationProperty,
